...
public interface Game {
     ...
     * @throws IncorrectTurnOrderException Caso não seja a vez de um jogador fazer um movimento
     * @throws IllegalMovementException    Caso uma peça seja movida para fora do tabuleiro ou para uma posição onde já tem uma peça da mesma cor
     * @throws InvalidCardException        Caso uma carta que não está na mão do jogador seja usada
     * @throws InvalidPieceException       Caso uma peça que não está no tabuleiro seja usada
     */
    default void makeMove(Piece piece, Card card, Position position) throws IncorrectTurnOrderException, IllegalMovementException, InvalidCardException, InvalidPieceException {
